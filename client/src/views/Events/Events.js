...
// Creating the event front end, back-end, css, and filtering functionality
...
class Events extends React.Component{
    ...
    constructor (){
        ...
        this.state = {
            ...
            searchFilter: "name",
            filterText: '',
            backgroundSet: Math.floor(Math.random() * 2)
        };
    }
    ...
    render(){
        ...
        function randomImage(backgroundSet){
                var backgroundImages = ['book1-background', 'field1-background'];
                var randomIndex = backgroundSet;
        ...
        .map((event) => {
            ...
            //Events that already happened will NOT appear
            if(event.date > today)
            {
                return (
                    <div class="columnEvents" style={{display: 'flex'}, {padding: '0px'}, {paddingTop: '0px'}, {justifyContent:'center', alignItems:'center'}}>
                        <div class="containerEvent">
                            ...
                            <tr style={{fontSize: 19}}>Related to: {event.tags.map ( tag => {
                                if(tag != event.tags[event.tags.length - 1])
                                {
                                    return (
        ...
        return (
            <div>
                ...
                <body className="Events">
                    <div className={randomImage(this.state.backgroundSet) }style={{overflow: "auto"}}> 
                        <div class="container">
